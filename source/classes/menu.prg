...
function MainMenu()
   ...
   ?              '      <li><a href="#" onclick="Go( ' + "'http://www.fivetechsoft.com/cgi-bin/fivegen?menu'" + ' );"' + '>Menus</a></li>'
   ?              '      <li><a href="#" onclick="Go( ' + "'http://www.fivetechsoft.com/cgi-bin/fivegen?forms'" + ' );"' + '>Forms</a></li>'
   ?              '      <li><a href="#" onclick="Go( ' + "'http://www.fivetechsoft.com/cgi-bin/fivegen?browses'" + ' );"' + '>Browses</a></li>'
   ?              '   </ul>'
   ?              '</li>'
   ?              '<li class="dropdown">'
   ?              '   <a class="dropdown-toggle" data-toggle="dropdown" href="#">Rules<span class="caret"></span></a>'
   ?              '   <ul class="dropdown-menu">'
   ?              '      <li><a href="#" onclick="Go( ' + "'http://www.fivetechsoft.com/cgi-bin/fivegen?vars'" + ' );"' + '>Variables</a></li>'
   ?              '      <li><a href="#" onclick="Go( ' + "'http://www.fivetechsoft.com/cgi-bin/fivegen?scripts'" + ' );"' + '>Scripts</a></li>'
   ?              '   </ul>'
   ?              '</li>'
   ?              '<li class="dropdown">'
