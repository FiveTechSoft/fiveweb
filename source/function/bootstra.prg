...
function Footer( cTableName )
   ...
   ?         '<div class="col-xs-4 text-center" style=width:25%;><a href="#" onclick="Go( ' + "'www.fivetechsoft.com/cgi-bin/fivegen?" + cTableName + 'edit:1' + ';"><br><i class="glyphicon glyphicon-pencil"></i><br><br>Edit</a></div>'
